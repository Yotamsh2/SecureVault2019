...
////    private EditText editTextExpiringDate;
...
////        editTextExpiringDate = findViewById(R.id.expiringDate_day);
...
//        final String expiringDate = editTextExpiringDate.getText().toString().trim();
...
//
//
//        public class SaveNewWebsiteRecord extends AsyncTask<Void, Void, Void> {
//
